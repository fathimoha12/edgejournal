...
Never store broker passwords, broker API secrets, or trading account credentials in this app. Gold Uleeye is only for manual forex journaling and trade analysis.

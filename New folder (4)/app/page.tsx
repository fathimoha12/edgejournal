...
import { ArrowRight, BarChart3, BookOpenCheck, CandlestickChart, Check, Database, LineChart, LockKeyhole } from "lucide-react";
...
const features = [
  ...
  },
  {
    ...
    description: "Gold Uleeye is a journal only. It never stores broker credentials or trading account passwords.",
  },
];
      ...
      <header className="sticky top-0 z-30 border-b bg-background/75 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link href="/" className="flex items-center gap-3">
            <BrandMark />
            <span className="font-semibold tracking-tight">Gold Uleeye</span>
          </Link>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[0.92fr_1.08fr]">
          <div className="pt-8">
            ...
            <h1 className="max-w-4xl text-5xl font-semibold tracking-tight sm:text-6xl lg:text-7xl">
              Gold Uleeye for serious FX performance.
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-muted-foreground">
              Journal every setup, measure edge by market condition, and turn trading behavior into a clean,
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <Button asChild size="lg" variant="outline">
                <Link href="/journal">Add first trade</Link>
              </Button>
            </div>
          </div>
      ...
      <section id="pricing" className="px-4 py-20 sm:px-6 lg:px-8">
        <Card className="glass-panel mx-auto max-w-3xl">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-3xl">Start free on your own Vercel domain.</CardTitle>
            <CardDescription>Designed for a free Vercel deployment and a Supabase free-tier project.</CardDescription>
          </CardHeader>
          <CardContent>
